...
Using loops and simple recursion (in some problems)

Examples include checking if a number is within a range, deciding sleep-in conditions, or summing numbers with constraints.
